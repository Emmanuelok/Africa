...
export const STRINGS: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "hero.no_card": "No card required",
    "hero.free_monthly": "1 determination free / month",
    "hero.countries": "25 countries supported",
    "hero.preview.step": "Step 3 of 3 · Result",
    "hero.preview.qualifies": "Qualifies",
    "hero.preview.lane": "Trade lane",
    "hero.preview.product": "Product",
    "hero.preview.rule": "Rule applied",
    "hero.preview.mfn": "MFN duty",
    "hero.preview.afcfta": "AfCFTA duty",
    "hero.preview.you_save": "You save",
    "hero.preview.cert_ready": "Certificate of Origin ready",
  ...
  fr: {
    ...
    "hero.no_card": "Aucune carte requise",
    "hero.free_monthly": "1 analyse gratuite / mois",
    "hero.countries": "25 pays pris en charge",
    "hero.preview.step": "Étape 3 sur 3 · Résultat",
    "hero.preview.qualifies": "Éligible",
    "hero.preview.lane": "Couloir commercial",
    "hero.preview.product": "Produit",
    "hero.preview.rule": "Règle appliquée",
    "hero.preview.mfn": "Droit NPF",
    "hero.preview.afcfta": "Droit ZLECAf",
    "hero.preview.you_save": "Vous économisez",
    "hero.preview.cert_ready": "Certificat d'origine prêt",
  ...
  pt: {
    ...
    "hero.no_card": "Sem cartão necessário",
    "hero.free_monthly": "1 análise grátis / mês",
    "hero.countries": "25 países suportados",
    "hero.preview.step": "Passo 3 de 3 · Resultado",
    "hero.preview.qualifies": "Qualifica-se",
    "hero.preview.lane": "Corredor comercial",
    "hero.preview.product": "Produto",
    "hero.preview.rule": "Regra aplicada",
    "hero.preview.mfn": "Direito NMF",
    "hero.preview.afcfta": "Direito ZCLCA",
    "hero.preview.you_save": "Você poupa",
    "hero.preview.cert_ready": "Certificado de Origem pronto",
  ...
  ar: {
    ...
    "hero.no_card": "بدون الحاجة إلى بطاقة",
    "hero.free_monthly": "تقييم واحد مجاناً شهرياً",
    "hero.countries": "25 دولة مدعومة",
    "hero.preview.step": "الخطوة 3 من 3 · النتيجة",
    "hero.preview.qualifies": "مؤهَّل",
    "hero.preview.lane": "ممر التجارة",
    "hero.preview.product": "المنتج",
    "hero.preview.rule": "القاعدة المطبَّقة",
    "hero.preview.mfn": "رسم الدولة الأكثر رعاية",
    "hero.preview.afcfta": "رسم الزلكاف",
    "hero.preview.you_save": "توفر",
    "hero.preview.cert_ready": "شهادة المنشأ جاهزة",
  ...
  sw: {
    ...
    "hero.no_card": "Hakuna kadi inayohitajika",
    "hero.free_monthly": "Uchunguzi 1 bure / mwezi",
    "hero.countries": "Nchi 25 zinaweza kushughulikiwa",
    "hero.preview.step": "Hatua 3 ya 3 · Matokeo",
    "hero.preview.qualifies": "Inastahili",
    "hero.preview.lane": "Njia ya biashara",
    "hero.preview.product": "Bidhaa",
    "hero.preview.rule": "Kanuni iliyotumika",
    "hero.preview.mfn": "Ushuru wa MFN",
    "hero.preview.afcfta": "Ushuru wa AfCFTA",
    "hero.preview.you_save": "Unakokoa",
    "hero.preview.cert_ready": "Cheti cha Asili kiko tayari",
