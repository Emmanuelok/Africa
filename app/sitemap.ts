...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPaths = [
    ...
    { p: "/docs", change: "weekly" as const, prio: 0.75 },
    { p: "/docs/getting-started", change: "monthly" as const, prio: 0.7 },
    { p: "/docs/concepts/afcfta", change: "monthly" as const, prio: 0.7 },
    { p: "/docs/concepts/rules-of-origin", change: "monthly" as const, prio: 0.7 },
    { p: "/docs/concepts/papss", change: "monthly" as const, prio: 0.65 },
    { p: "/docs/afriorigin/classify", change: "monthly" as const, prio: 0.7 },
    { p: "/docs/afriorigin/origin-determination", change: "monthly" as const, prio: 0.7 },
    { p: "/docs/afriorigin/certificates", change: "monthly" as const, prio: 0.7 },
    { p: "/docs/afriorigin/languages", change: "monthly" as const, prio: 0.6 },
    { p: "/docs/api", change: "monthly" as const, prio: 0.7 },
    { p: "/docs/api/authentication", change: "monthly" as const, prio: 0.65 },
    { p: "/docs/api/webhooks", change: "monthly" as const, prio: 0.65 },
    { p: "/docs/api/errors", change: "monthly" as const, prio: 0.6 },
