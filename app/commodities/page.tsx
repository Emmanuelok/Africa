...
export const metadata = { title: "Commodity Prices — Sokoni" };
  ...
  return (
    <div className="bg-pattern">
      <div className="mx-auto max-w-7xl px-4 py-10 md:px-6 md:py-14">
        <Badge tone="terracotta">Commodity prices</Badge>
        <h1 className="mt-3 font-display text-3xl font-semibold md:text-4xl">
          Continental price discovery
        </h1>
        <p className="mt-2 max-w-2xl text-ink-600">
          Indicative benchmarks for African export commodities. So SMEs and cooperatives can negotiate
          from data, not vibes. Production rollout pulls from Refinitiv, S&amp;P Global Platts, and
          national commodity exchanges (ECX, GCX, JSE).
        </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-ink-200">
                ...
                pricing in local markets, Sokoni aggregates these alongside global benchmarks so an
                Ivorian cocoa cooperative can price against ICCO <em>and</em> the Abidjan spot — and
                see what an Egyptian or Moroccan buyer would pay landed.
              </p>
            </div>
          </div>
        </Card>
